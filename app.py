...
menu = st.sidebar.radio("Go to", ["Project Overview", "1. Data Cleaning & Binning", "2. Univariate Analysis", "3. Bivariate & Multivariate Analysis", "4. Full Code Explorer", "5. View Raw Source Code", "Credits & Contact"])
